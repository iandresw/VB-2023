...
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} rpAvisoDeCobro 
   ...
   _ExtentX        =   26432
   _ExtentY        =   18441
   SectionData     =   "rpAvisoDeCobro3.dsx":0000
End
...
Private Sub ActiveReport_ReportStart()
    ...
    sql = sql & " WHERE (AvPgEnc.AvPgEstado = 1) AND (AvPgEnc.Identidad = '" & id & "') AND (AvPgEnc.AvPgTipoImpuesto IN (5,1)) AND (CuentaIngreso_A.Tipo <> 2)"
